		...
		<div class="bg-surface border-t-4 border-t-accent-primary max-w-2xl w-full max-h-[80vh] flex flex-col" style="box-shadow: var(--shadow-floating);">
			<div class="p-4 border-b border-accent-track flex items-center justify-between">
				...
				<button
					onclick={onClose}
					aria-label="Close"
					class="w-8 h-8 flex items-center justify-center text-text-secondary hover:text-text-primary hover:bg-surface-elevated transition-colors"
				>
						...
						<div class="mb-4">
							...
							<div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
								...
								<button
									...
									class="text-left p-3 bg-surface-elevated border border-accent-track hover:border-accent-primary hover:bg-surface transition-colors"
								>
